                        ...
                        <div class="swiper-container zoom-top">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide zoom-image-hover">
                                    <img class="img-responsive m-auto" src="{{ URL::to($row->product_image) }}"
                    ...
                    <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="product-details-content quickview-content">
                            ...
                            <div class="pricing-meta">
                                <ul>
                                    <li class="old-price not-cut">{{ $row->product_price }} Tk</li>
                                </ul>
                            </div>
                            ...
                            @if (session()->has('success'))
                                <strong class="text-alert">{{ session()->get('success') }}</strong>
                            @endif
                            <p class="mt-30px mb-0">{{ $row->product_short_description }}</p>
                            <div class="pro-details-quality">
                                <form action="{{ route('allcart', $row->id) }}" method="POST" class="pro-details-quality">
                                    $@csrf
                                    ...
                                    <div class="pro-details-cart">
                                        <button class="add-cart" href="{{ route('allcart', $row->id) }}"> Add To
                                            Cart</button>
                                    </div>
