                        ...
                        <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                  ...
                                  @if ($row->status==1)
                                  <a href="{{ route('unactive.cetegory',$row->id) }}">
                                      <i class="fa fa-thumbs-up" style="font-size:30px;color:rgb(161, 215, 33)"></i>
                                  </a>
                                  @else
                                  <a href="{{ route('active.cetegory',$row->id) }}">
                                  ...
                                  <a href="{{ route('category.delete',$row->id) }}" class="btn btn-danger"><i class='far fa-trash-alt'></i></a>
                              </td>
                          </tr>
                          @endforeach
                        </tbody>
